      ...
      <v-container>
        <v-row class="align-center">
          ...
          <v-col cols="4" class="d-flex justify-center">
            <img src="@/assets/images/footer-logo.webp" style="width: 130px"
          /></v-col>
...
<script>
import NavBadgeVue from "./nav/NavBadge.vue";
export default {
  inject: ["Emitter"],
  components: {
    NavBadgeVue,
  ...
  methods: {
    ...
    openMenu() {
      this.Emitter.emit("openMenuParent");
    },
  },
};
</script>
