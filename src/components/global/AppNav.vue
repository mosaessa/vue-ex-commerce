    ...
    <v-app-bar color="#02218f" class="pt-3" height="fit-content" absolute>
      <v-container fluid>
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <span class="mt-1" style="color: white">Wish List</span>
              </div>
              <div class="wishlists d-flex flex-column align-center">
                <svg
                ...
                <span class="mt-1" style="color: white">Sign In</span>
              </div>
              <div
              ...
              >
                ...
                <span class="mt-1" style="color: white">Cart</span>
              </div>
            </div>
          </v-col>
        </v-row>
        <v-row class="mt-6">
          ...
          <v-col cols="4" class="d-flex justify-end" style="gap: 35px">
            ...
            <div
              ...
              id="language-btn"
            >
              <span v-html="selectdLang[0].icon"></span>
              <span
                >{{ selectdLang[0].lang }} / {{ selectdLang[0].currency }}
              </span>
              <v-icon>mdi-chevron-down</v-icon>
              <v-menu activator="#language-btn">
                <v-list v-model:selected="selectdLang" mandatory>
                  <v-list-item
                    v-for="lang in langs"
                    :key="lang.lang"
                    :value="lang"
