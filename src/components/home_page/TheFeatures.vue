        ...
        <v-col cols="12" sm="6" md="4" lg="4">
          ...
          >
            <svg
              ...
              viewBox="0 0 640 512"
              class="mb-5 mb-sm-0 svg-inline--fa fa-shipping-fast fa-w-20 fa-3x mr-5"
            >
              <path
                fill="currentColor"
        ...
        <v-col cols="12" sm="6" md="4" lg="4">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
              class="mb-5 mb-sm-0 svg-inline--fa fa-award fa-w-12 fa-3x mr-5"
            >
              <path
                fill="currentColor"
        ...
        <v-col cols="12" sm="6" md="4" lg="4">
          ...
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              class="mb-5 mb-sm-0 svg-inline--fa fa-trophy-alt fa-w-18 fa-3x mr-5"
            >
              <path
                fill="currentColor"
