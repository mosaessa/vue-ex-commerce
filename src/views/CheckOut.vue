      ...
      <v-row>
        <v-col cols="12" md="7" class="order-1 order-md-0">
          ...
          >
            ...
            <v-card-actions class="justify-space-between mb-7">
              <v-btn
                class="flex-grow-1"
                color="#6200ff"
                variant="elevated"
            ...
            <div
              class="user_name d-flex align-center justify_center"
              style="gap: 10px"
            >
              <input
                class="pa-3 mt-4"
            ...
            />
            <div
              class="city d-flex align-center justify_center"
              style="gap: 10px"
            >
              <input
                class="pa-3 mt-4"
              ...
              <select
                name=""
                id=""
                class="w-100 pa-3 form-control mt-4"
                style="
                  border: 1px solid rgb(217, 217, 217);
                  border-radius: 3px;
                  font-size: 14px;
            ...
            <v-card-actions class="justify-center my-7">
              <v-btn
                @click="dialog = true"
                width="150"
                height="45"
            ...
            <v-divider color="black" length="100%"></v-divider>
            <v-card-text style="font-size: 10; color: #777777"
        ...
        <v-col cols="12" md="5">
          ...
          >
            ...
            >
              ...
              <v-card-text class="flex-grow-0 font-weight-bold text-green">
                ${{
                  Math.ceil(
            ...
            <v-card-text
              ...
              ><span>Total</span>
              <span class="text-green">${{ calcTotalPrice }}</span></v-card-text
            >
          </v-card>
        </v-col>
      </v-row>
...
import OrderSuccessVue from "@/components/order_success/OrderSuccess.vue";
export default {
  components: { OrderSuccessVue },
  computed: {
